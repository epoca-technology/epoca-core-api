...
describe('Database Brainstorm: ',  function() {
    ...
    it('-Can store a set of processed candlesticks, retrieve them and validate their integrity: ', async function() {
        ...
        try {
            ...
            for (let c of processed) {
                await client.query({
                    text: `
                        INSERT INTO test_candlesticks(ot, ct, o, h, l, c, v, tbv, nt) 
            ...
            try {
                await client.query({
                    text: `
                        ...
                        VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
                    `,
                    values: [last.ot, last.ct, last.o, last.h, last.l, last.c, last.v, last.tbv, last.nt]
                });
