...
export class PositionHealth implements IPositionHealth {
    ...
    private evaluateTrendSum(side: IBinancePositionSide, openSum: number): number {
        ...
        const absDiff: number = this._prediction.calculateAbsoluteTrendSumDifference(openSum, this.pred.s);

        // Evaluate a trend sum that is increasing
        if (this.pred.s > openSum) {
            if        (absDiff >= 1.05)   { score = side == "LONG" ? 1: 0 } 
            else if   (absDiff >= 1.01)   { score = side == "LONG" ? 0.99: 0.01 }
            else if   (absDiff >= 0.99)   { score = side == "LONG" ? 0.98: 0.02 }
            else if   (absDiff >= 0.96)   { score = side == "LONG" ? 0.97: 0.03 }
            else if   (absDiff >= 0.93)   { score = side == "LONG" ? 0.96: 0.04 }
            else if   (absDiff >= 0.90)   { score = side == "LONG" ? 0.95: 0.05 }
            else if   (absDiff >= 0.87)   { score = side == "LONG" ? 0.94: 0.06 }
            else if   (absDiff >= 0.84)   { score = side == "LONG" ? 0.93: 0.07 }
            else if   (absDiff >= 0.81)   { score = side == "LONG" ? 0.92: 0.08 }
            else if   (absDiff >= 0.78)   { score = side == "LONG" ? 0.91: 0.09 }
            else if   (absDiff >= 0.75)   { score = side == "LONG" ? 0.90: 0.10 }
            else if   (absDiff >= 0.72)   { score = side == "LONG" ? 0.89: 0.11 }
            else if   (absDiff >= 0.69)   { score = side == "LONG" ? 0.88: 0.12 }
            else if   (absDiff >= 0.66)   { score = side == "LONG" ? 0.87: 0.13 }
            else if   (absDiff >= 0.63)   { score = side == "LONG" ? 0.86: 0.14 }
            else if   (absDiff >= 0.60)   { score = side == "LONG" ? 0.85: 0.15 }
            else if   (absDiff >= 0.57)   { score = side == "LONG" ? 0.84: 0.16 }
            else if   (absDiff >= 0.54)   { score = side == "LONG" ? 0.83: 0.17 }
            else if   (absDiff >= 0.51)   { score = side == "LONG" ? 0.82: 0.18 }
            else if   (absDiff >= 0.48)   { score = side == "LONG" ? 0.81: 0.19 }
            else if   (absDiff >= 0.45)   { score = side == "LONG" ? 0.80: 0.20 }
            else if   (absDiff >= 0.42)   { score = side == "LONG" ? 0.79: 0.21 }
            else if   (absDiff >= 0.39)   { score = side == "LONG" ? 0.78: 0.22 }
            else if   (absDiff >= 0.36)   { score = side == "LONG" ? 0.77: 0.23 }
            else if   (absDiff >= 0.33)   { score = side == "LONG" ? 0.76: 0.24 }
            else if   (absDiff >= 0.30)   { score = side == "LONG" ? 0.75: 0.25 }
            else if   (absDiff >= 0.28)   { score = side == "LONG" ? 0.74: 0.26 }
            else if   (absDiff >= 0.26)   { score = side == "LONG" ? 0.73: 0.27 }
            else if   (absDiff >= 0.24)   { score = side == "LONG" ? 0.72: 0.28 }
            else if   (absDiff >= 0.22)   { score = side == "LONG" ? 0.71: 0.29 }
            else if   (absDiff >= 0.20)   { score = side == "LONG" ? 0.70: 0.30 }
            else if   (absDiff >= 0.19)   { score = side == "LONG" ? 0.69: 0.31 }
            else if   (absDiff >= 0.18)   { score = side == "LONG" ? 0.68: 0.32 }
            else if   (absDiff >= 0.17)   { score = side == "LONG" ? 0.67: 0.33 }
            else if   (absDiff >= 0.16)   { score = side == "LONG" ? 0.66: 0.34 }
            else if   (absDiff >= 0.15)   { score = side == "LONG" ? 0.65: 0.35 }
            else if   (absDiff >= 0.14)   { score = side == "LONG" ? 0.64: 0.36 }
            else if   (absDiff >= 0.13)   { score = side == "LONG" ? 0.63: 0.37 }
            else if   (absDiff >= 0.12)   { score = side == "LONG" ? 0.62: 0.38 }
            else if   (absDiff >= 0.11)   { score = side == "LONG" ? 0.61: 0.39 }
            else if   (absDiff >= 0.10)   { score = side == "LONG" ? 0.60: 0.40 }
            else if   (absDiff >= 0.09)   { score = side == "LONG" ? 0.59: 0.41 }
            else if   (absDiff >= 0.08)   { score = side == "LONG" ? 0.58: 0.42 }
            else if   (absDiff >= 0.07)   { score = side == "LONG" ? 0.57: 0.43 }
            else if   (absDiff >= 0.06)   { score = side == "LONG" ? 0.56: 0.44 }
            else if   (absDiff >= 0.05)   { score = side == "LONG" ? 0.55: 0.45 }
            else if   (absDiff >= 0.04)   { score = side == "LONG" ? 0.54: 0.46 }
            else if   (absDiff >= 0.03)   { score = side == "LONG" ? 0.53: 0.47 }
            else if   (absDiff >= 0.02)   { score = side == "LONG" ? 0.52: 0.48 }
            else if   (absDiff >= 0.01)   { score = side == "LONG" ? 0.51: 0.49 }
        }

        // Evaluate a trend sum that is decreasing
        else if (this.pred.s < openSum) {
            if        (absDiff >= 1.05)   { score = side == "SHORT" ? 1: 0 } 
            else if   (absDiff >= 1.01)   { score = side == "SHORT" ? 0.99: 0.01 }
            else if   (absDiff >= 0.99)   { score = side == "SHORT" ? 0.98: 0.02 }
            else if   (absDiff >= 0.96)   { score = side == "SHORT" ? 0.97: 0.03 }
            else if   (absDiff >= 0.93)   { score = side == "SHORT" ? 0.96: 0.04 }
            else if   (absDiff >= 0.90)   { score = side == "SHORT" ? 0.95: 0.05 }
            else if   (absDiff >= 0.87)   { score = side == "SHORT" ? 0.94: 0.06 }
            else if   (absDiff >= 0.84)   { score = side == "SHORT" ? 0.93: 0.07 }
            else if   (absDiff >= 0.81)   { score = side == "SHORT" ? 0.92: 0.08 }
            else if   (absDiff >= 0.78)   { score = side == "SHORT" ? 0.91: 0.09 }
            else if   (absDiff >= 0.75)   { score = side == "SHORT" ? 0.90: 0.10 }
            else if   (absDiff >= 0.72)   { score = side == "SHORT" ? 0.89: 0.11 }
            else if   (absDiff >= 0.69)   { score = side == "SHORT" ? 0.88: 0.12 }
            else if   (absDiff >= 0.66)   { score = side == "SHORT" ? 0.87: 0.13 }
            else if   (absDiff >= 0.63)   { score = side == "SHORT" ? 0.86: 0.14 }
            else if   (absDiff >= 0.60)   { score = side == "SHORT" ? 0.85: 0.15 }
            else if   (absDiff >= 0.57)   { score = side == "SHORT" ? 0.84: 0.16 }
            else if   (absDiff >= 0.54)   { score = side == "SHORT" ? 0.83: 0.17 }
            else if   (absDiff >= 0.51)   { score = side == "SHORT" ? 0.82: 0.18 }
            else if   (absDiff >= 0.48)   { score = side == "SHORT" ? 0.81: 0.19 }
            else if   (absDiff >= 0.45)   { score = side == "SHORT" ? 0.80: 0.20 }
            else if   (absDiff >= 0.42)   { score = side == "SHORT" ? 0.79: 0.21 }
            else if   (absDiff >= 0.39)   { score = side == "SHORT" ? 0.78: 0.22 }
            else if   (absDiff >= 0.36)   { score = side == "SHORT" ? 0.77: 0.23 }
            else if   (absDiff >= 0.33)   { score = side == "SHORT" ? 0.76: 0.24 }
            else if   (absDiff >= 0.30)   { score = side == "SHORT" ? 0.75: 0.25 }
            else if   (absDiff >= 0.28)   { score = side == "SHORT" ? 0.74: 0.26 }
            else if   (absDiff >= 0.26)   { score = side == "SHORT" ? 0.73: 0.27 }
            else if   (absDiff >= 0.24)   { score = side == "SHORT" ? 0.72: 0.28 }
            else if   (absDiff >= 0.22)   { score = side == "SHORT" ? 0.71: 0.29 }
            else if   (absDiff >= 0.20)   { score = side == "SHORT" ? 0.70: 0.30 }
            else if   (absDiff >= 0.19)   { score = side == "SHORT" ? 0.69: 0.31 }
            else if   (absDiff >= 0.18)   { score = side == "SHORT" ? 0.68: 0.32 }
            else if   (absDiff >= 0.17)   { score = side == "SHORT" ? 0.67: 0.33 }
            else if   (absDiff >= 0.16)   { score = side == "SHORT" ? 0.66: 0.34 }
            else if   (absDiff >= 0.15)   { score = side == "SHORT" ? 0.65: 0.35 }
            else if   (absDiff >= 0.14)   { score = side == "SHORT" ? 0.64: 0.36 }
            else if   (absDiff >= 0.13)   { score = side == "SHORT" ? 0.63: 0.37 }
            else if   (absDiff >= 0.12)   { score = side == "SHORT" ? 0.62: 0.38 }
            else if   (absDiff >= 0.11)   { score = side == "SHORT" ? 0.61: 0.39 }
            else if   (absDiff >= 0.10)   { score = side == "SHORT" ? 0.60: 0.40 }
            else if   (absDiff >= 0.09)   { score = side == "SHORT" ? 0.59: 0.41 }
            else if   (absDiff >= 0.08)   { score = side == "SHORT" ? 0.58: 0.42 }
            else if   (absDiff >= 0.07)   { score = side == "SHORT" ? 0.57: 0.43 }
            else if   (absDiff >= 0.06)   { score = side == "SHORT" ? 0.56: 0.44 }
            else if   (absDiff >= 0.05)   { score = side == "SHORT" ? 0.55: 0.45 }
            else if   (absDiff >= 0.04)   { score = side == "SHORT" ? 0.54: 0.46 }
            else if   (absDiff >= 0.03)   { score = side == "SHORT" ? 0.53: 0.47 }
            else if   (absDiff >= 0.02)   { score = side == "SHORT" ? 0.52: 0.48 }
            else if   (absDiff >= 0.01)   { score = side == "SHORT" ? 0.51: 0.49 }
        }
