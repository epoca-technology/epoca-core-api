...
export class PositionService implements IPositionService {
    ...
    private getDefaultStrategy(): IPositionStrategy {
        ...
        return {
            ...
            leverage: 5,
            position_size: 150,
            take_profit_1: { price_change_requirement: 0.75, max_hp_drawdown: -25,   max_gain_drawdown: -60 },
            take_profit_2: { price_change_requirement: 1.5,  max_hp_drawdown: -20,   max_gain_drawdown: -40 },
            take_profit_3: { price_change_requirement: 2.25, max_hp_drawdown: -15,   max_gain_drawdown: -15 },
            take_profit_4: { price_change_requirement: 3,    max_hp_drawdown: -7.5,  max_gain_drawdown: -10 },
            take_profit_5: { price_change_requirement: 5,    max_hp_drawdown: -2.5,  max_gain_drawdown: -5 },
            max_hp_drawdown_in_profit: -35,
            stop_loss: 4,
            max_hp_drawdown_in_loss: -50,
