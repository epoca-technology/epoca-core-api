...
export class PositionService implements IPositionService {
    ...
    private getDefaultStrategy(): IPositionStrategy {
        ...
        return {
            ...
            leverage: 5,
            position_size: 150,
            take_profit_1: { price_change_requirement: 0.75, max_hp_drawdown: -20, max_gain_drawdown: -30 },
            take_profit_2: { price_change_requirement: 1.5,  max_hp_drawdown: -10, max_gain_drawdown: -20 },
            take_profit_3: { price_change_requirement: 2.25, max_hp_drawdown: -6,  max_gain_drawdown: -10 },
            take_profit_4: { price_change_requirement: 3,    max_hp_drawdown: -3,  max_gain_drawdown: -7.5 },
