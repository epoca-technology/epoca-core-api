...
@injectable()
export class LongShortRatioTTPStateService implements ILongShortRatioTTPStateService {
    // Inject dependencies
    ...
    private async updateState(): Promise<void> {
        try {
            ...
            const records: IBinanceLongShortRatio[] = await this._binance.getLongShortRatio("topLongShortPositionRatio");
            ...
            console.error("The long short ratio top trader position state could not be updated due to an error in Binance API.", e);
