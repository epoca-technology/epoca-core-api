...
/**
 * Futures Income
 * Binance API provides the income generated in a given date range.
 */
export type IBinanceIncomeType = "TRANSFER"|"WELCOME_BONUS"|"REALIZED_PNL"|"FUNDING_FEE"|"COMMISSION"|"INSURANCE_CLEAR"|
...
export interface IBinanceIncomeRecord {
    // The symbol in which the income was generated
    ...
    // Income Type
    incomeType: IBinanceIncomeType, // "REALIZED_PNL"

    // The income generated by the transaction (can be a negative value)
    income: string, // "0.15060000" <- This is the amount that should be processed and stored

    // The time in milliseconds at which the income was generated
    time: number, // 1680876998000

    // @TODO
    info: string, // "255897832"

    // The unique identifier of the transaction
    tranId: number, // 90030255897832 <- Turn this value into a string

    // The identifier of the trade (if any)
    tradeId: string // "255897832"|""
}
